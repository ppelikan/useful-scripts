...
init ()
{
openocd -f interface/ftdi/jtagkey.cfg -f target/stm32f4x.cfg  #wywołanie OpenOcd, inicjacja połączenia, TUTAJ ZMIENIAJ: programator oraz docelowy µC
}
...
sleep 1 
 ...
 sleep 1
 echo $AA
 sleep 6                    # czekaj 4 sekundy, aż zostanie wgrany program
 sleep 1
 echo "resume"
 sleep 1
 echo "reset"
